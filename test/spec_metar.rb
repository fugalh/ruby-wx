...
context 'plumtv problem metars' do
  blizzard = METAR.parse('METAR KGLD 272053Z AUTO 34034G40KT 1/4SM SN FG BKN003 OVC009 00/M01 A2934 RMK AO2 PK WND 34041/2025')
  blizzard2 = METAR.parse('METAR KANW 282030Z AUTO 33034G48KT M1/4SM +SN OVC001 M07/M08 A2955')
  blowsnow = METAR.parse('CYYQ 151100Z 34015G30KT 1/2SM -SN BLSN VV005 M05/M07 A2975 RMK S8 SLP002=')
  tstorm = METAR.parse('METAR CYOW 160800Z 21004KT 8SM -TSRA BKN020 OVC100 20/18 A2966 RMK SC5AC3 CB EMBDD LTGCG SE SLP044=')
end
